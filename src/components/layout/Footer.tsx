    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <span className="font-heading text-lg font-bold">Silva & Associados</span>
                <span className="block text-xs text-gold tracking-[0.2em] uppercase">Advocacia</span>
              </div>
            </div>
            <p className="text-sm text-primary-foreground/70 leading-relaxed">
              Compromisso com a excelência jurídica e a defesa dos direitos dos nossos clientes há mais de 20 anos.
            </p>
          </div>

          <div>
            <h4 className="font-heading text-gold font-semibold mb-4">Navegação</h4>
          ...
          <div>
            <h4 className="font-heading text-gold font-semibold mb-4">Áreas de Atuação</h4>
          ...
          <div>
            <h4 className="font-heading text-gold font-semibold mb-4">Contato</h4>
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2 text-primary-foreground/70">
                <MapPin className="w-4 h-4 mt-0.5 text-gold shrink-0" />
                Av. Paulista, 1000, Sala 501<br />São Paulo - SP, 01310-100
              </li>
        ...
        <div className="border-t border-navy-light/30 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-primary-foreground/50">
          <p>© {new Date().getFullYear()} Silva & Associados Advocacia. Todos os direitos reservados.</p>
