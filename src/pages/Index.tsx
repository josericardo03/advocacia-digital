          ...
          <div className="max-w-2xl animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                <Button
                  size="lg"
                  className="bg-emerald-500 text-white hover:bg-emerald-600 font-semibold text-base px-8 border-none"
                >
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <Button
                size="lg"
                className="bg-emerald-500 text-white hover:bg-emerald-600 font-semibold px-8 border-none"
              >
                <Phone className="mr-2 w-5 h-5" />
                WhatsApp
              </Button>
